...
static int showsystray = 1;       /* 1 means systray is enabled */
static int systrayspacing = 2;   /* space between systray icons */
static int systrayonleft = 0;    /* 0 means systray is on the right */
static unsigned int systraypinning = 0; /* screen to pin systray */
static unsigned int systraypinningfailfirst = 1; /* fall back on first monitor */
/* Vanity gaps */
static const int gappih = 10; /* inner horizontal gap between windows */
static const int gappiv = 10; /* inner vertical gap between windows */
static const int gappoh = 10; /* outer horizontal gap between windows and screen edge */
static const int gappov = 10; /* outer vertical gap between windows and screen edge */
